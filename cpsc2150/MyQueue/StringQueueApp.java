...
public class StringQueueApp{
	...
	public static void main(String[] args) {
		...
		while(selection != 8){
			...
			if(selection == 5){
				System.out.println("What String to add to queue?");
				String stringWanted = input.next();
